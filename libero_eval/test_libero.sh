...
python experiments/robot/libero/run_libero_eval.py \
  --pretrained_checkpoint /media/liuzhuoyang/LCoT_VLA_MOT/exp/latent_cot_mot_flow_libero/janus_pro_siglip_uni3d_1B_1e-4_mot_pretrain0123e0_libero_spatial_joint_chunk16_stride8_view1+1_wrist_slow1_fast1_state_8_0210/stage3/checkpoint-199-331200/tfmr \
