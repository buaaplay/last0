...
BASE_RUN_NAME="janus_pro_siglip_uni3d_1B_1e-4_mot_sparse_slow1_fast4_pc_state_12_1216"
EXPERIMENT_NAME="latent_cot_mot_diff"
OUTPUT_ROOT_DIR="../exp"

DATA_JSON="/media/liuzhuoyang/LCoT_VLA_MOT/training_data/json/4tasks_1view_chunk4_fastslow_train.json"
...
if [ -z "$MANUAL_S1_CKPT" ]; then
    ...
    accelerate launch --config_file ../config/sft.yaml \
        ...
        --num_machines 1 \
        --machine_rank 0 \
        --deepspeed_multinode_launcher standard train_janus_siglip_diff_fastslow.py \
...
echo "Config: Freeze Latent = 1, Epochs = 100"
echo "=========================================================="
