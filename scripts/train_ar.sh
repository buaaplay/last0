...
run_name="janus_pro_siglip_1B_1e-4_mot_s0_latent4_chunk4_add_1203"

accelerate launch --config_file ../config/sft.yaml \
    --num_processes 8  \
    --num_machines 1 \
    --machine_rank 0 \
    --deepspeed_multinode_launcher standard train_janus_siglip_ar.py \
    --model_path /media/liuzhuoyang/LCoT_VLA_MOT/exp/latent_cot_mot/janus_pro_siglip_1B_1e-4_mot_s0_latent2_chunk4_1203/checkpoint-59-1740/tfmr \
