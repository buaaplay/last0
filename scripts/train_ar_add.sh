...
run_name="janus_pro_siglip_1B_1e-4_mot_s2_latent4_chunk4_add_1203"

accelerate launch --config_file ../config/sft.yaml \
    --num_processes 8  \
    --num_machines 1 \
    --machine_rank 0 \
    --deepspeed_multinode_launcher standard train_janus_siglip_ar_add.py \
    --model_path /media/liuzhuoyang/LCoT_VLA_MOT/exp/latent_cot_mot/janus_pro_siglip_1B_1e-4_mot_s0_latent4_chunk4_add_1203/checkpoint-59-1740/tfmr \
    --data_path /media/liuzhuoyang/LCoT_VLA_MOT/training_data/json/4tasks_chunk4_train.json \
    --data_root "" \
    --n_epochs 100 \
    --action_dim 7 \
    --train_bsz_per_gpu 8 \
