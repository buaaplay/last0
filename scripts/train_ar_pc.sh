...
run_name="janus_pro_siglip_1B_1e-4_mot_s2_latent1_chunk4_pc1_[uni3d]_1211"

accelerate launch --config_file ../config/sft.yaml \
    --num_processes 8  \
    --num_machines 1 \
    --machine_rank 0 \
    --deepspeed_multinode_launcher standard train_janus_siglip_ar_pc.py \
    --model_path /media/liuzhuoyang/LCoT_VLA_MOT/exp/latent_cot_mot/janus_pro_siglip_1B_1e-4_mot_s2_latent1_chunk4_pc1_[uni3d]_1211/checkpoint-59-1740/tfmr \
