...
BASE_RUN_NAME="janus_pro_siglip_uni3d_1B_1e-4_mot_para_latent_pc_state_12_1216"
EXPERIMENT_NAME="latent_cot_mot_diff"
OUTPUT_ROOT_DIR="../exp"

DATA_JSON="/media/liuzhuoyang/LCoT_VLA_MOT/training_data/json/4tasks_chunk4_img+pc+state_train.json"
...
if [ -z "$MANUAL_S1_CKPT" ]; then
    ...
    accelerate launch --config_file ../config/sft.yaml \
        ...
        --num_machines 1 \
        --machine_rank 0 \
        --deepspeed_multinode_launcher standard train_janus_siglip_diff_para.py \
